...
class Speed_Output(BaseFuzzy):
    ...
    def freeze_very_low(self, temperature, pressure):
        if temperature == "freeze" and pressure == "very_low":
            return self.fast(130)
        else:
            return 0

    def cold_very_low(self, temperature, pressure):
        if temperature == "cold" and pressure == "very_low":
            return self.fast(130)
        else:
            return 0

    def warm_very_low(self, temperature, pressure):
        if temperature == "warm" and pressure == "very_low":
            return self.fast(130)
        else:
            return 0

    def hot_very_low(self, temperature, pressure):
        if temperature == "hot" and pressure == "very_low":
            return self.fast(130)
        else:
            return 0

    def freeze_low(self, temperature, pressure):
        if temperature == "freeze" and pressure == "low":
            return self.fast(130)
        else:
            return 0

    def cold_low(self, temperature, pressure):
        if temperature == "cold" and pressure == "low":
            return self.steady(130)
        else:
            return 0

    def warm_low(self, temperature, pressure):
        if temperature == "warm" and pressure == "low":
            return self.steady(130)
        else:
            return 0

    def hot_low(self, temperature, pressure):
        if temperature == "hot" and pressure == "low":
            return self.steady(130)
        else:
            return 0

    def freeze_medium(self, temperature, pressure):
        if temperature == "freeze" and pressure == "medium":
            return self.steady(130)
        else:
            return 0

    def cold_medium(self, temperature, pressure):
        if temperature == "cold" and pressure == "medium":
            return self.steady(130)
        else:
            return 0

    def warm_medium(self, temperature, pressure):
        if temperature == "warm" and pressure == "medium":
            return self.steady(130)
        else:
            return 0

    def hot_medium(self, temperature, pressure):
        if temperature == "hot" and pressure == "medium":
            return self.steady(130)
        else:
            return 0

    def freeze_high(self, temperature, pressure):
        if temperature == "freeze" and pressure == "high":
            return self.steady(130)
        else:
            return 0

    def cold_high(self, temperature, pressure):
        if temperature == "cold" and pressure == "high":
            return self.steady(130)
        else:
            return 0

    def warm_high(self, temperature, pressure):
        if temperature == "warm" and pressure == "high":
            return self.steady(130)
        else:
            return 0

    def hot_high(self, temperature, pressure):
        if temperature == "hot" and pressure == "high":
            return self.slow(130)
        else:
            return 0

    def freeze_very_high(self, temperature, pressure):
        if temperature == "freeze" and pressure == "very_high":
            return self.slow(130)
        else:
            return 0

    def cold_very_high(self, temperature, pressure):
        if temperature == "cold" and pressure == "very_high":
            return self.slow(130)
        else:
            return 0

    def warm_very_high(self, temperature, pressure):
        if temperature == "warm" and pressure == "very_high":
            return self.slow(130)
        else:
            return 0

    def hot_very_high(self, temperature, pressure):
        if temperature == "hot" and pressure == "very_high":
            return self.slow(130)
        else:
            return 0
    ...
    def graph(self, ax):
        ...
        y_steady = [self.steady(s) for s in x]
        y_fast = [self.fast(s) for s in x]

        ax.plot(x, y_slow, label='Slow')
        ax.plot(x, y_steady, label='Steady')
